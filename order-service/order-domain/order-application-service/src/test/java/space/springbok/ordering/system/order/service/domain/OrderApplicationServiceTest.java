...
import space.springbok.ordering.system.domain.valueobject.*;
...
import space.springbok.ordering.system.order.service.domain.dto.create.OrderItem;
...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("5baf28cf-d5cd-45f6-9a3d-0b3ea38cf097");
    private final UUID RESTAURANT_ID = UUID.fromString("5baf28cf-d5cd-45f6-9a3d-0b3ea38cf099");
    private final UUID PRODUCT_ID = UUID.fromString("fed90ae2-d220-4a8b-91b3-b99afc4e915b");
    private final UUID ORDER_ID = UUID.fromString("fa78b900-8d17-473c-a03b-f290cbafbda9");
    ...
    public void init() {
        ...
        when(restaurantRepository.findRestaurantInformation(orderDataMapper.createOrderCommandToRestaurant(createOrderCommand))).thenReturn(
