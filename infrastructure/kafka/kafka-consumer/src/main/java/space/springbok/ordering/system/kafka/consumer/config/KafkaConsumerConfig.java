package space.springbok.ordering.system.kafka.consumer.config;
...
import space.springbok.ordering.system.kafka.config.data.KafkaConfigData;
import space.springbok.ordering.system.kafka.config.data.KafkaConsumerConfigData;
